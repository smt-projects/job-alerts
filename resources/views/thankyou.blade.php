...
<script>
  ...
  gtag('config', 'UA-28422152-1');
    ...
    <body class="antialiased thankyouPage">
    ...
    <section class="headGroupWrap">
            ...
            <div class="container"> 
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 d-flex justify-content-end">                         
                        <nav class="navbar navbar-expand-lg main_nav_sec">
        ...
        <section class="siteBanner">
            <div class="container">
                <div class="thankuPage_bannerbox">
                    <div class="bannerBox_inner text-center">
                        <img src="{!! asset('theme/dist/img/thanku_icon.png') !!}" class="img-fluid" >
                        <h2>Success!</h2>
                        <h3>You Are Good To Go</h3>
                        <h6>Thank you for signing up for our job alert emails!</h6>
                        <p>We will be sending you relevant job openings for your selected categories once a week. If you have questions, please reach out to us!</p>
                        <a href="<?php echo $hostwithHttp; ?>/job-postings">See Open Jobs</a>
                    </div>
                    <section class="one_col__section">
                        <div class="container oneCol__section_inner">
                            <div class="row">
                                <div class="col-md-7 offset-md-1 d-flex justify-content-end align-items-center">
                                ...
                                <div class="col-md-3 d-flex justify-content-md-end justify-content-center align-items-md-center">
                                    <!-- <a href="#">Sign Up</a> -->
    ...
    <section class="two_col__section">
        <div class="container">
            <div class="row">
    ...
    <footer class="siteFooter"> 
            ...
            <div class="container"> 
                <div class="row">
                	<div class="col-md-3 text-md-left text-sm-center">
                		<a class="footer-logo" href="<?php echo $hostwithHttp; ?>">
        ...
        <section class="siteFooter__copytxt"> 
            <p class="text-center">© Copyright <?php echo date('Y');?> <a href="<?php echo $hostwithHttp; ?>/">VanderHouwen</a> - All Rights Reserved | <a href="<?php echo $hostwithHttp; ?>/privacy-policy">Privacy policy</a></p> 
        </section>             
    </footer> 
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-header">
              ...
              <div class="modal-body">
                <iframe src="https://vdhnewstag2022.vanderhouwen.com/signup-form/" title="description" style="width: 100%; height: 308px;"></iframe>
              </div>
